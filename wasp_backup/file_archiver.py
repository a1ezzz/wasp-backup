...
from wasp_backup.archiver import WBackupTarArchiver


class WBackupFileArchiver(WBackupTarArchiver):
	...
	def meta(self):
		result = WBackupTarArchiver.meta(self)
		result[WBackupMeta.Archive.MetaOptions.archived_files] = self.backup_sources()
		return result


class WBackupLVMFileArchiver(WBackupFileArchiver):
	...
	def archive(
		...
		try:
			...
			WBackupFileArchiver.archive(self)
	...
	def meta(self):
		meta = WBackupFileArchiver.meta(self)
