...
# -*- coding: utf-8 -*-
#
# wasp-backup documentation build configuration file, created by
...
htmlhelp_basename = 'wasp-backupdoc'
...
latex_documents = [
	(master_doc, 'wasp-backup.tex', 'wasp-backup Documentation',
...
man_pages = [
	(master_doc, 'wasp-backup', 'wasp-backup Documentation',
	[author], 1)
]
...
texinfo_documents = [
	(master_doc, 'wasp-backup', 'wasp-backup Documentation',
	author, 'wasp-backup', 'One line description of project.',
	'Miscellaneous'),
]
...
main(['-e', '-o', os.path.join(sphinx_dir, 'api'), os.path.join(os.path.dirname(__file__), '..', '..', 'wasp_backup')])
